...
if ! python -c 'import pandas, argparse, os, regex, smallBixTools, numpy, sklearn, tensorflow, matplotlib' &> /dev/null; then
    echo "Installing required Python packages..."
    pip install pandas argparse regex smallBixTools numpy sklearn tensorflow matplotlib
fi
